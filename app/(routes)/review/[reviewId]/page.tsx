      ...
      <div className="flex justify-center">
        <div className="absolute top-[300px] max-lg:m-4 ">
          <div
            ...
            className="w-[900px] max-lg:w-full p-10 max-sm:p-5 bg-white rounded-md font-[family-name:var(--font-gilroy-medium)]"
          ></div>
          <div 
            ...
            style={{backgroundColor:`${anilistData.media.coverImage.color ?? "red"} `}}
            >
            {anilistData.score}
